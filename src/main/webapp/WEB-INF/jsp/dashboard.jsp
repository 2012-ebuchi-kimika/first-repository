        ...
        <div class="search-container">
          <div class="search-box-group" style="display: flex; align-items: center; gap: 8px;">
            ...
            <input type="text" id="searchInput" class="search-box search-box-slim"
              placeholder="🔍 会議・タスク・キーワード検索..." value="<c:out value='${keyword}'/>"
              oninput="filterDashboardAll()"
              onkeydown="if(event.key === 'Enter') { event.preventDefault(); filterDashboardAll(); }">

            <button type="button" id="btn-execute-search" class="btn-secondary btn-secondary-slim"
              onclick="filterDashboardAll()">検索</button>
            <button type="button" id="btn-clear-keyword-search" class="btn-secondary btn-clear-slim"
              onclick="clearKeywordSearch()">クリア</button>

          </div>
        </div>
      </div>

      <!-- ★ 2行目: メインコンテンツ（左右2カラム構造） -->
              ...
              <c:choose>
                ...
                <c:otherwise>
                  <c:forEach var="m" items="${meetings}">
                    <div class="meeting-item" data-meeting-id="${m.meetingId}"
                      data-title="<c:out value='${m.title}'/>" data-start-time="${m.startTime}"
                      ...
                      <div style="display: flex; justify-content: space-between; align-items: center; gap: 8px; margin-bottom: 4px;">
                        <div class="meeting-title" title="<c:out value='${m.title}'/>"
                        ...
                        <div style="display: flex; align-items: center; gap: 8px; flex-shrink: 0;">
                          ...
                          <div style="font-size: 8pt; display: flex; gap: 6px;">
                            <button type="button" class="btn-edit-meeting"
                            ...
                            <button type="button" class="btn-delete-meeting"
        ...
        <div class="right-col">
          <div class="card">
            <div class="card-header card-header-slim">
              ...
              <span style="font-size: 8pt; font-weight: normal; color: #64748b;" id="taskCountLabel">全
                <c:out value="${fn:length(tasks)}" /> 件
              </span>
            </div>
              ...
              <div class="filter-grid-row2" style="display: flex; align-items: center; justify-content: space-between; gap: 8px;">
                ...
                <div style="display: flex; align-items: center; gap: 8px; margin-left: auto;">
                  <label class="completed-toggle" style="margin: 0; white-space: nowrap;">
                    <input type="checkbox" id="showCompletedCheck" onchange="filterDashboardAll()"
